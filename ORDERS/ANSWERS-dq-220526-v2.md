...
- [**§ 2.3**](#sec-23) — Математический аппарат LC-кривых: исходные ряды нормируются к диапазону $[0;1]$, затем сопоставляются LC-кривая и диагональ равномерности, а форма и взаимное смещение кривых задают **операционное окно упреждения** для перехода МЧС к превентивному реагированию.
