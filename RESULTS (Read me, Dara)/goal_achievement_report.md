# Научно-технический отчет: Достижение цели исследования ВКР
## Разработка комплекса математических моделей и системы поддержки принятия решений (СППР) для управления рисками деградации вечной мерзлоты и наводнений в Якутии
...
```mermaid
graph TD
    A[Этап 1. Исследование и очистка данных] --> B[Этап 2. Разработка математических моделей]
    B --> C[Этап 3. Проектирование индексов и матрицы СППР]
    C --> D[Этап 4. Разработка ПО: пакет permafrost_model и СППР CLI]
    D --> E[Этап 5. Верификация тестами и генерация графиков для ВКР]
    E --> F[Итоговый результат: Готовая научная глава и расчетный комплекс]
```
...
---
*Отчет подготовлен научно-методическим ассистентом Antigravity и сохранен в каталог результатов.*
